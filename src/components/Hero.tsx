    ...
    <section className="relative overflow-hidden">
      <div className="mx-auto grid max-w-6xl items-center gap-12 px-5 py-20 md:px-8 md:py-28 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          <h1 className="mt-5 text-4xl font-semibold leading-[1.25] tracking-tight text-green-deep sm:text-5xl">
            배움을 넘어,
            <br />
            스스로 생각하는 아이로.
          </h1>
          ...
          <div className="mt-10 flex flex-wrap gap-3">
            <Link
              href="/about"
              className="rounded-sm border border-green-deep px-7 py-3.5 text-sm font-medium text-green-deep transition-colors hover:bg-green-deep hover:text-white"
            >
              학원 알아보기
            </Link>
            <Link
